...
| — Tier-1 code sets populated (cited) | 52 (SYSCOHADA 17 + 35 single/regional: PGC SNC PCGE CAS PCMN CGNC SCF RO CZ SK HU BG UA KZ TN BY RS HR SI AT + inline) |
| Descriptive placeholders excluded from Tier-1 (B1) | 14 |
| Entities consolidated | 71 |
| Jurisdictions exercised in run | 65 |
| Local entries processed | 346 |
| Deterministic coverage (Tier 1+2) | 97.1% (Tier1 83.8% + Tier2 13.3%) |
...
| Consolidated total assets (USD) | 13,906,038 |
