...
openings and a 2.0\% unemployment rate --- strong by any labor-market
...
categorizes accountants and auditors --- the judgment-intensive tier ---
...
reconciliation. These are the tasks the BLS and WEF identify as
automation-susceptible. The CPA-level tasks --- cross-jurisdictional interpretation,
...
The Co-responsibility Architecture (CRA, Section~\ref{sec:governance}) carries a labor-market
...
\textbf{Skill premium and complementarity.} The PwC Global AI Jobs
Barometer (2025), an analysis of close to a billion job advertisements
across six continents, found a 56\% wage premium for roles requiring AI
skills, and 7.5\% year-on-year growth in postings requiring AI skills
across sectors (PwC reports the growth economy-wide, not for finance
specifically). Mäkelä \& Stephany (2024) analyzed 12 million job vacancies
...
\textbf{Practitioner-level evidence.} ICAEW's 2026 mid-tier firms study
(\emph{Evolution of Mid-Tier Accountancy Firms}), which surveyed leaders
from 35 mid-tier UK firms in February--March 2026, found that 68\% of
respondents believed AI would reduce demand for some early-career
accounting roles, but 83\% stated it would not result in fewer roles
overall, and 71\% reported that AI had enabled their teams to move up the
value chain toward advisory and strategic work (ICAEW, 2026). The sample
is small and bounded to the mid-tier segment, so this is directional
practitioner sentiment rather than population-level evidence; its pattern
--- automation compressing entry-level execution while expanding
senior-level advisory demand --- is nonetheless the recomposition dynamic
at the firm level.
...
economy instruments (tokenized securities, CBDC settlement, multi-agent
...
expertise tier the labor market is already unable to supply.
...
is resolved by a qualified human, with durable, logged attribution. The labor-market
