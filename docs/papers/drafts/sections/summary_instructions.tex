...
Read the abstract for the thesis; the Introduction for the problem; the Evaluation
section for the coverage figures and their full enumeration; and the
\hyperref[sec:glossary]{Glossary}, which defines every coined term once. Every
quantitative claim in this paper is regenerable from a committed command in the
public repository; where a number is an estimate or an illustrative model rather
than a measurement, the text says so explicitly.
